package com.contacts.common_contacts.adapters;
...
public class ContactListAdapter extends ArrayAdapter<ContactItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(bm!=null){
			profilePic.setImageBitmap(Utilities.getCircleImage(bm, 120, 120));
		}else{
			profilePic.setImageResource(R.drawable.sample_profile_pic);
		}
		return v;
